...
# קופסת רקע מקדימה (Hero Box) עם רקע, הסבר ושאלות מנחות
st.markdown(
    """
    <div class="hero-box">
        <h3 style="margin-top: 0; color: #1f3bb3;">ברוכים הבאים לדאשבורד ניתוח שוק הדיור 🏘️</h3>
        <p style="font-size: 16px; line-height: 1.6; color: #333;">
            שוק הדיור בישראל מתאפיין לאורך שנים בדינמיקה מרתקת ומורכבת, המונעת משילוב של גידול דמוגרפי מהיר, 
            אתגרי היצע מבניים ושינויי מאקרו-כלכליים דרמטיים. דאשבורד זה מרכז ומנתח את הנתונים הרשמיים כדי 
        ...
        <p style="font-size: 16px; line-height: 1.6; color: #333; margin-bottom: 5px;">
            <strong>כמה שאלות מרכזיות שעומדות במוקד המערכת:</strong>
        </p>
        ...
        <p style="font-size: 13px; color: #666; margin-top: 15px; margin-bottom: 0;">
            <em>מוזמנים לעבור בין הלשוניות השונות כדי לחקור את הנתונים, הגרפים והתובנות המלאות.</em>
        </p>
    </div>
    """,
    unsafe_allow_html=True
